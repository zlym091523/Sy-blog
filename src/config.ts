...
export const siteConfig: SiteConfig = {
	title: "Shawyoung",
	subtitle: "欢迎光临肖洋小屋",
	siteURL: "https://yoviz.dpdns.org//", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
...

		{
			...
			children: [
				...
				{
					name: "WeChat",
					url: "https://postimg.cc/HVbVnjNw",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "QQ",
					url: "https://qm.qq.com/q/dpKcWQnZTi",
					external: true,
					icon: "fa7-brands:qq",
				},
				{
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "zlym091523/commentConfig", // 你的 GitHub 仓库地址，例如 "username/repo"
		repoId: "R_kgDOSrDGVQ",
		category: "Announcements",
		categoryId: "DIC_kwDOSrDGVc4C-EIK",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to visit Shawyoung's world!", // 欢迎词
		touch: [
			"OwO 你在摸哪里？",
			"啊！好痒！",
			"不要忘记多喝水，好好吃饭哦！",
